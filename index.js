  ...
  men: {
    featured: [
      {
        ...
        price: 45000,
        originalPrice: 60000,
        image: "images/slim-fit-suit.jpg",
        rating: 4.5,
        reviews: 36,
        discount: 25,
      ...
      },
      {
        ...
        price: 22000,
        originalPrice: 25000,
        image: "images/designer-denim-jeans.jpg",
        rating: 4.7,
        reviews: 42,
        discount: 12,
    ...
    newArrivals: [
      ...
      },
      {
        ...
        price: 8500,
        originalPrice: 12000,
        image: "images/silk-pocket-square-set.jpg",
        rating: 4.4,
        reviews: 15,
        discount: 29,
        colors: ["multicolor"],
      ...
      },
      {
        ...
        price: 19000,
        originalPrice: 23000,
        image: "images/tailored-dress-pant.jpg",
        rating: 4.3,
        reviews: 27,
        discount: 17,
...
function loadPreviewProducts() {
  ...
  products.men.featured.slice(0, 2).forEach((product) => {
    ...
    item.innerHTML = `
            ...
            <button onclick="showQuickView('${product.id}', 'men')" class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50 transition-opacity duration-300">
  ...
  products.women.featured.slice(0, 2).forEach((product) => {
    ...
    item.innerHTML = `
            ...
            <button onclick="showQuickView('${product.id}', 'women')" class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50 transition-opacity duration-300">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
              </svg>
...
function createProductCard(product, category) {
  ...
  card.innerHTML = `
    ...
    product.name
            ...
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50 transition-opacity duration-300 space-x-2">
  ...
  card.addEventListener("click", () => showQuickView(product.id, category));
  return card;
}
...
document.addEventListener("DOMContentLoaded", function () {
  const slides = document.querySelectorAll("#home .absolute.inset-0.bg-cover");
  let currentSlide = 0;
